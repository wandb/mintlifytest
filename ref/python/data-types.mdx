...
|-----------|-------------|
| [`Image`](/ref/python/data-types/image) | Log images with support for masks, bounding boxes, and segmentation. |
| [`Video`](/ref/python/data-types/video) | Track video data for model outputs or dataset samples. |
| [`Audio`](/ref/python/data-types/audio) | Log audio samples for audio processing tasks. |
| [`Table`](/ref/python/data-types/table) | Create tables that can contain mixed media types. |
| [`Plotly`](/ref/python/data-types/plotly) | Log Plotly charts for data visualization. |
| [`Html`](/ref/python/data-types/html) | Embed custom HTML content. |
| [`Object3D`](/ref/python/data-types/object3d) | Visualize 3D point clouds and meshes. |
| [`Molecule`](/ref/python/data-types/molecule) | Log molecular structures for computational chemistry. |
