...
# Next Steps
- Check out the [reference documentation](/guides/artifacts/construct-an-artifact/) on `artifacts`.
- Go through our [Tables Walktrough](/guides/tables/tables-walkthrough/) guide.
