...
- [Track experiments](/guides/track/) using runs or sweeps.
- [Configure deployment settings](/guides/app/settings-page/) and [defaults](/guides/app/features/cascade-settings/).
- [Add panels](/guides/app/features/panels/) to visualize your experiments, such as line plots, bar plots, media panels, query panels, and tables.
- [Add custom charts](/guides/app/features/custom-charts/).
- [Create and share reports](/guides/reports/).
