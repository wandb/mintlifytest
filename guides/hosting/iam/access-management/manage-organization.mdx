...
To learn more about how to setup SSO with Dedicated cloud or Self-managed instances, refer to [SSO with OIDC](/guides/hosting/iam/sso/) or [SSO with LDAP](/guides/hosting/iam/ldap/).
</Note>
...
By default, only a team or instance admin can invite members to a team. To change this behavior, refer to [Team settings](/guides/hosting/iam/access-management/manage-organization/#invite-users-to-a-team).
