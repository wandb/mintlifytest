...
Every project is comprised of [Workspaces](/guides/track/workspaces/) and [Reports](/guides/reports/), and is linked to relevant [Artifacts](/guides/artifacts/), [Sweeps](/guides/sweeps/), and [Automations](/guides/automations/).
