...
* Authenticate with [SSO using OpenID Connect (OIDC)](/guides/hosting/iam/sso/) or with [LDAP](/guides/hosting/iam/ldap/).
...
* Leverage JSON Web Tokens with [identity federation](/guides/hosting/iam/identity_federation/) to access W&B APIs.
...
To understand how W&B manages updates on Dedicated Cloud, refer to the [server release process](/guides/hosting/server-upgrade-process/).
...
Migration to Dedicated Cloud from a [Self-Managed instance](/guides/hosting/hosting-options/self-managed/) or [Multi-tenant Cloud](/guides/hosting/hosting-options/saas_cloud/) is supported, subject to specific limits and migration-related constraints
