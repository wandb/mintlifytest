...
See specific cloud provider documentation for more information on how to set up W&B Server in [AWS](/guides/hosting/self-managed/aws-tf/), [GCP](/guides/hosting/self-managed/gcp-tf/), or [Azure](/guides/hosting/self-managed/azure-tf/).
...
See [Install on on-prem infrastructure](/guides/hosting/self-managed/bare-metal/) for detailed instructions to install W&B Server on your on-prem infrastructure. W&B can provide recommendations for the different components and provide guidance through the installation process.
