...
def generate_random_audio_wave_read(duration=2, sample_rate=44100):
    ...
    # Rewind the buffer to the beginning so you can read from it
    buffer.seek(0)
...
![The Evals tab](/guides/evaluation/img/evals_tab.png)

![The Comparison view](/guides/evaluation/img/comparison.png)
