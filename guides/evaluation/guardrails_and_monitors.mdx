...
4. Configure the monitor as follows:
    ...
    ![Creating a monitor part 1](/guides/evaluation/img/monitors-ui-1.png)
    - **Calls to Monitor**:
        ...
        ![Creating a monitor part 2](/guides/evaluation/img/monitors-ui-2.png)
    - **LLM-as-a-Judge Configuration**:
        ...
        - **Scoring prompt**:  
            ...
            ```
            ![Creating a monitor part 3](/guides/evaluation/img/monitors-ui-3.png)
...
9. Inspect the trace to see the monitor in action. For this example, the monitor correctly evaluated the `output` (in this instance, equivalent to the `ground_truth`) as `true` and provided sound `reasoning`.
    ![Monitor trace](/guides/evaluation/img/monitors-4.png)
