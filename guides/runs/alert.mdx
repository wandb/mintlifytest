...
<Note>
W&B Alerts require you to add `run.alert()` to your code. Without modifying your code, [Automations](/guides/automations/) provide another way to notify Slack based on an event in W&B, such as when an [artifact](/guides/artifacts/) artifact version is created or when a [run metric](/guides/runs/) meets or changes by a threshold.
...
Read the [Automations overview](/guides/automations/) or [create an automation](/guides/automations/create-automations/).
</Note>
