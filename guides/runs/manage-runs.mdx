...
To customize the **Runs** tab, refer to [Project page](/guides/track/project-page/#runs-tab).

If you group runs into experiments, refer to [Set a group in the UI](/guides/runs/grouping/#set-a-group-in-the-ui).
