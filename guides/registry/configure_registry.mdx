...
A registry admin can [configure registry roles](configure_registry.md#configure-registry-roles), [add users](configure_registry.md#add-a-user-or-a-team-to-a-registry), or [remove users](configure_registry.md#remove-a-user-or-team-from-a-registry) from a registry by configuring the registry's settings.
...
Learn more about [configuring user roles in a registry](configure_registry.md#configure-registry-roles), or [Registry role permissions](configure_registry.md#registry-role-permissions) . 
...
<Note>
Your [role in a team](/guides/models/app/settings-page/teams#team-role-and-permissions) has no impact or relationship to your role in any registry.
</Note>
...
See [Configure user roles in a registry](configure_registry.md#configure-registry-roles) for more information.
