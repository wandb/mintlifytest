...
<Note>
W&B will eventually stop supporting W&B Model Registry. Users are encouraged to instead use [W&B Registry](/guides/registry/) for linking and sharing their model artifacts versions. W&B Registry broadens the capabilities of the legacy W&B Model Registry. For more information about W&B Registry, see the [Registry docs](/guides/registry/).


W&B will migrate existing model artifacts linked to the legacy Model Registry to the new W&B Registry in the near future. See [Migrating from legacy Model Registry](/guides/registry/model_registry_eol/) for information about the migration process.
</Note>
...
* [Bookmark your best model versions for each machine learning task.](/guides/registry/model_registry/link-model-version/)
* [Automate](/guides/automations/) downstream processes and model CI/CD.
...
4. **Connect model transitions to CI/CD workflows**: transition candidate models through workflow stages and [automate downstream actions](/guides/automations/) with webhooks.
...
* Read the [models walkthrough](/guides/registry/model_registry/walkthrough/) for a step-by-step outline of the W&B Python SDK commands you could use to create, track, and use a dataset artifact.
* Learn about:
   * [Protected models and access control](/guides/registry/model_registry/access_controls/).
   * [How to connect Registry to CI/CD processes](/guides/automations/).
   * Set up [Slack notifications](/guides/registry/model_registry/notifications/) when a new model version is linked to a registered model.
