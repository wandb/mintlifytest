...
- Explore enhanced functionality in the Registry such as:
    - [Organization-level access](/guides/registry/create_registry/#visibility-types)
    - [Role-based access control](/guides/registry/configure_registry/)
    - [Registry-level lineage tracking](/guides/registry/lineage/)
