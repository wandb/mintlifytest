...
<Info>
See the summary table in [Registry types](registry_types.md#summary) for a complete comparison of core and custom registries.
</Info>
...
Use the [`wandb.Api().create_registry()`](/ref/python/public-api/Api/#method-apicreate_registry) method to create a custom registry programmatically. Provide a name and [visibility](#visibility-types) for the registry for the `name` and `visibility` parameters, respectively.
...
See the  [`wandb.Api().create_registry()`](/ref/python/public-api/Api/#method-apicreate_registry) method reference for a full list of parameters that you can provide when you create a custom registry.
</Tab>
</Tabs>
