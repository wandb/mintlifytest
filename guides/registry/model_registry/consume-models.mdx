...
See [`use_model`](/ref/python/experiments/run#use_model) in the API Reference guide for more information on possible parameters and return type.
...
See [`use_model`](/ref/python/experiments/run#use_model) in the API Reference guide for parameters and return type.
</Tab>
<Tab title="W&B App">
