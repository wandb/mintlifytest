...
# Next Steps
- Check out the [reference documentation](/guides/core/artifacts/construct-an-artifact) on `artifacts`.
- Go through our [Tables Walktrough](/guides/models/tables/tables-walkthrough) guide.
