...
If histograms are in your summary they will appear on the Overview tab of the [Run Page](/guides/models/track/runs/). If they are in your history, we plot a heatmap of bins over time on the Charts tab.
...
Using this schema, you can define a Python object and pass it in to [the `from_point_cloud` method](/ref/python/data-types/Object3D/#from_point_cloud).
...
On the W&B [Run](/guides/models/track/runs/) and [Project](/guides/models/track/project-page) Pages, you will see your videos in the Media section.
