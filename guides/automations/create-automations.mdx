...
This page gives an overview of creating and managing W&B [automations](/guides/automations/). For more detailed instructions, refer to [Create a Slack automation](/guides/automations/create-automations/slack/) or [Create a webhook automation](/guides/automations/create-automations/webhook/).
...
## Requirements
- A team admin can create and manage automations for the team's projects, as well as components of their automations, such as webhooks, secrets, and Slack integrations. Refer to [Team settings](/guides/app/settings-page/team-settings/).
- To create a registry automation, you must have access to the registry. Refer to [Configure Registry access](/guides/registry/configure_registry/#registry-roles).
...
1. If necessary, [create a W&B secret](/guides/secrets/) for each sensitive string required by the automation, such as an access token, password, or SSH key. Secrets are defined in your **Team Settings**. Secrets are most commonly used in webhook automations.
...
Or, from a line plot in the workspace, you can quickly create a [run metric automation](/guides/automations/automation-events/#run-events) for the metric it shows:
...
## Next steps
- Learn more about [automation events and scopes](/guides/automations/automation-events/)
- [Create a Slack automation](/guides/automations/create-automations/slack/).
- [Create a webhook automation](/guides/automations/create-automations/webhook/).
- [Create a secret](/guides/secrets/).
