...
<Note>
The preceding code snippet, and the colab linked on this page, show how to initialize and create a sweep with wht W&B CLI. See the [Sweeps walkthrough](/guides/sweeps/walkthrough/) for a step-by-step outline of the W&B Python SDK commands to use to define a sweep configuration, initialize a sweep, and start a sweep.
</Note>
...
* Read through the [sweeps walkthrough](/guides/sweeps/walkthrough/) for a step-by-step outline of the W&B Python SDK commands to use to define a sweep configuration, initialize a sweep, and start a sweep.
* Explore this chapter to learn how to:
  * [Add W&B to your code](/guides/sweeps/add-w-and-b-to-your-code/)
  * [Define sweep configuration](/guides/sweeps/define-sweep-configuration/)
  * [Initialize sweeps](/guides/sweeps/initialize-sweeps/)
  * [Start sweep agents](/guides/sweeps/start-sweep-agents/)
  * [Visualize sweep results](/guides/sweeps/visualize-sweep-results/)
* Explore a [curated list of Sweep experiments](/guides/sweeps/useful-resources/) that explore hyperparameter optimization with W&B Sweeps. Results are stored in W&B Reports.
