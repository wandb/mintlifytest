...
Use the artifact object's [`logged_by`](/ref/python/experiments/artifact#logged_by) and [`used_by`](/ref/python/experiments/artifact#used_by) methods to walk the graph from the artifact:
