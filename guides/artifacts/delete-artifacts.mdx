...
An artifact version can also be deleted programmatically via the [delete()](/ref/python/experiments/artifact#delete) method. See the examples below. 
...
You can also delete artifact collection programmatically with the [delete()](/ref/python/experiments/artifact#delete) method. Provide the name of the project and entity for the `project` and `entity` keys in `wandb.Api`, respectively:
