...
See the [Artifacts quickstart](/guides/artifacts/artifacts-walkthrough/) for information on how to save files and directories to W&B servers instead.
</Note>
