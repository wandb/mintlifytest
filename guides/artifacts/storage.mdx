...
For sensitive files, we recommend you set up [Private Hosting](/guides/hosting/) or use [reference artifacts](/guides/artifacts/track-external-files/).
...
For a complete guide to using environment variables to configure W&B, see the [environment variables reference](/guides/track/environment-variables/).
