...
2. **Code saving**: When reproducing a model, it's hard to know which cells in a notebook ran, and in which order. Turn on code saving on your [settings page](/guides/app/settings-page/) to save a record of cell execution for each experiment.
...
<Note>
Want to know more about what you can do with W&B? Check out our [guide to logging data and media](/guides/track/log/), learn [how to integrate us with your favorite ML toolkits](/guides/integrations/), or just dive straight into the [reference docs](/ref/python/) or our [repo of examples](https://github.com/wandb/examples).
</Note>
