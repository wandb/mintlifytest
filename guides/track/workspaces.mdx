...
* **Panel sections**: A section that contains one or more [panels](/guides/app/features/panels/). Create new panels, organize them, and export to reports to save snapshots of your workspace.
...
1. Configure the workspace's [line plot settings](/guides/app/features/panels/line-plot/#all-line-plots-in-a-workspace) according to your preferences.
