...
* Create a [launch job](./create-and-deploy-jobs/create-launch-job).
...
For advanced queue configuration options, see the [advanced queue setup page](/launch/set-up-launch/setup-queue-advanced).
