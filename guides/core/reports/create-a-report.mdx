...
2. Next, import workspaces
    ...
    ```       
3. Create a report with `wandb_workspaces.reports.v2.Report`. Create a report instance with the Report Class Public API ([`wandb.apis.reports`](/ref/python/public-api/api.md#reports)). Specify a name for the project.   
    ```python
...
For information on how to edit a report interactively with the App UI or programmatically, see [Edit a report](/guides/core/reports/edit-a-report).
</Tab>
</Tabs>
