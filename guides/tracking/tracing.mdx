...
<Tabs>
  <Tab title="Python">
    ...
    2. Change the display name on a per-call basis. This uses the [`Op.call`](../../reference/python-sdk/weave/trace/op.mdx#function-call) method to return a `Call` object, which you can then use to set the display name using [`Call.set_display_name`](../../reference/python-sdk/weave/trace/weave_client.mdx#method-set_display_name).
    ```python showLineNumbers
    result, call = my_function.call("World")
...
<Tabs>
    ...
    <Tab title="HTTP API">
    * Start a call: [POST `/call/start`](../../reference/service-api/index.mdx)
    * End a call: [POST `/call/end`](../../reference/service-api/index.mdx)
    ```bash
...
<Tabs>
    ...
    **Search Query:**
    ...
    <Tab title="HTTP API">
    To view a call using the Service API, you can make a request to the [`/call/read`](../../reference/service-api/index.mdx) endpoint.
...
<Tabs>
    <Tab title="Python">
    In order to set the display name of a call, you can use the [`Call.set_display_name`](../../reference/python-sdk/weave/trace/weave_client.mdx#method-set_display_name) method.
    ...
    <Tab title="HTTP API">
    To set the display name of a call using the Service API, you can make a request to the [`/call/update`](../../reference/service-api/index.mdx) endpoint.
...
<Tabs>
    <Tab title="Python">
    To delete a Call using the Python API, you can use the [`Call.delete`](../../reference/python-sdk/weave/trace/weave_client.mdx#method-delete) method.
    ...
    <Tab title="HTTP API">
    To delete a call using the Service API, you can make a request to the [`/calls/delete`](../../reference/service-api/index.mdx) endpoint.
...
<Tabs>
    <Tab title="Python">
    To fetch calls using the Python API, you can use the [`client.get_calls`](../../reference/python-sdk/weave/trace/weave_client.mdx#method-get_calls) method:
    ...
    <Tab title="HTTP API">
    The most powerful query layer is at the Service API. To fetch calls using the Service API, you can make a request to the [`/calls/stream_query`](../../reference/service-api/index.mdx) endpoint.
