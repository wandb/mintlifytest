...
![Trace page panels](/guides/tracking/imgs/trace-tree-full.png)
...
![Filter an op by name](/guides/tracking/imgs/trace-tree-filter.png)
...
![Trace panel scrubbers](/guides/tracking/imgs/trace-tree-scrubbers.png)
...
![Trace panel code view](/guides/tracking/imgs/trace-tree-code-view.png)
...
![Trace panel flame graph](/guides/tracking/imgs/trace-tree-flame-view.png)
