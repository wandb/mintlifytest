...
<Warning>
This approach is a workaround and may change in future releases. You are actively working on a more robust API to support pairwise evaluations. Stay tuned for updates!
</Warning>
