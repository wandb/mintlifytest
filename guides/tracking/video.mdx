...
![A trace of a video processing function in the Traces table.](/guides/tracking/imgs/video-trace.png)

![An MP4 video uploaded to Weave, viewed in the Traces popout.](/guides/tracking/imgs/video-trace-popout.png)