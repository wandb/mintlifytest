...
![Screenshot of Feedback tab in call details](/guides/tracking/imgs/feedback_tab.png)
...
![Screenshot of calls grid with feedback column](/guides/tracking/imgs/feedback_calls.png)
...
![Human Annotation scorer form](/guides/tracking/imgs/human-annotation-scorer-form.png)
...
4. In the upper right corner, click the **Show feedback** button.
   ...
   ![Marker icon in call header](/guides/tracking/imgs/marker-icon.png)

   Your available human annotation scorers display in the sidebar.

   ![Human Annotation scorer feedback sidebar](/guides/tracking/imgs/full-feedback-sidebar.png)
...
![Human Annotation scorer feedback in calls table](/guides/tracking/imgs/feedback-in-the-table.png)
...
![Human Annotation scorer history](/guides/tracking/imgs/human-annotation-scorer-history.png)
