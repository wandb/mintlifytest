...
Using [Artifacts](/guides/artifacts/), you can store up to 100GB of models and datasets for free and then use the W&B [Registry](/guides/registry/). Using Registry, you can register models to explore and evaluate them, prepare them for staging, or deploy them in your production environment.
...
#### W&B Registry
Once you have logged your checkpoints to Artifacts, you can then register your best model checkpoints and centralize them across your team with [Registry](/guides/registry/). Using Registry, you can organize your best models by task, manage the lifecycles of models, track and audit the entire ML lifecyle, and [automate](/guides/automations/) downstream actions.

To link a model Artifact, refer to [Registry](/guides/registry/).
...
Once you have logged your training results you can explore your results dynamically in the [W&B Dashboard](/guides/track/workspaces/). It's easy to compare across dozens of runs at once, zoom in on interesting findings, and coax insights out of complex data with flexible, interactive visualizations.
...
If you save your model checkpoints as Artifacts, you can promote them to the [Registry](/guides/registry/). In Registry, you can:
