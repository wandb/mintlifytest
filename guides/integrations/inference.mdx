...
<Note>
The `weave` library is only required if you'll be using Weave to trace your LLM applications. For information on getting started with Weave, see the [Weave Quickstart](/quickstart). 
...
![Traces display](/guides/integrations/imgs/image.png)
...
![View your model evaluations](/guides/integrations/imgs/inference-advanced-evals.png)

![View your traces](/guides/integrations/imgs/inference-advanced-leaderboard.png)
...
![The Inference tab](/guides/integrations/imgs/inference-ui.png)
...
![The Inference models dropdown in Playground](/guides/integrations/imgs/inference-playground.png)
...
![Using an Inference model in the Playground](/guides/integrations/imgs/inference-playground-single.png)
...
![Select multiple models to compare in Playground](/guides/integrations/imgs/inference-playground-compare.png)
