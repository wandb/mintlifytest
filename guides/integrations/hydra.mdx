...
If your process hangs when started, this may be caused by [this known issue](/guides/track/log/distributed-training/). To solve this, try to changing wandb's multiprocessing protocol either by adding an extra settings parameter to `wandb.init()` as:
