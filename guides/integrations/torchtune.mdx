...
If you want to save the model checkpoints to [W&B Artifacts](/guides/artifacts/), the simplest solution is to override the `save_checkpoint` functions inside the corresponding recipe. 
