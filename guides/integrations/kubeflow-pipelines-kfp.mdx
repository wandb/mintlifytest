...
You may need to explicitly pass [environment variables](/guides/track/environment-variables/) to your containers. For two-way linking, you should also set the environment variables `WANDB_KUBEFLOW_URL` to the base URL of your Kubeflow Pipelines instance. For example, `https://kubeflow.mysite.com`.
...
| ------------------ | --- | --------------- |
| Input Scalar | [`config`](/guides/models/) | [Overview tab](/guides/runs/#overview-tab) |
| Output Scalar | [`summary`](/guides/models/) | [Overview tab](/guides/runs/#overview-tab) |
| Input Artifact | Input Artifact | [Artifacts tab](/guides/runs/#artifacts-tab) |
| Output Artifact | Output Artifact | [Artifacts tab](/guides/runs/#artifacts-tab) |
