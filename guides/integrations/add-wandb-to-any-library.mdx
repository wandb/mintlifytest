...
For more information on how to define a config file, see [Configure experiments](/guides/track/config/).

### Log to W&B

#### Log metrics

Create a dictionary where the key value is the name of the metric. Pass this dictionary object to [`run.log`](/guides/models/):
...
See the [`wandb.Run.log()` reference](/guides/models/).
...
See the [logging guide](/guides/models/) for media, objects, plots, and more.
