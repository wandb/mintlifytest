...
1. Set the `WANDB_API_KEY` [environment variable](/guides/track/environment-variables/) and log in:
...
Learn more in the [W&B Tables guide](/guides/tables/visualize-tables/) and the [Tables tutorial](../../tutorials/tables.md).
