...
[Prodigy](https://prodi.gy/) is an annotation tool for creating training and evaluation data for machine learning models, error analysis, data inspection & cleaning. [W&B Tables](/guides/tables/tables-walkthrough/) allow you to log, visualize, analyze, and share datasets (and more!) inside W&B.
