...
To automatically log gradients, you can call [`wandb.Run.watch()`](/ref/python/experiments/run.md/#method-runwatch) and pass in your PyTorch model.
...
If you need to track multiple models in the same script, you can call [`wandb.Run.watch()`](/ref/python/experiments/run/#method-runwatch) on each model separately.
...
For more on logging rich media to W&B in PyTorch and other frameworks, check out our [media logging guide](/guides/models/track/log/media).
...
For more on logging and visualizing datasets and models, check out our [guide to W&B Tables](/guides/models/tables/).
