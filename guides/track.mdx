...
2. Store a dictionary of hyperparameters, such as learning rate or model type, into your configuration ([`wandb.Run.config`](/guides/track/config/)).
3. Log metrics ([`wandb.Run.log()`](/guides/track/log/)) over time in a training loop, such as accuracy and loss.
