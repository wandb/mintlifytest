...
This page describes _automations_ in W&B. [Create an automation](/guides/automations/create-automations/) to trigger workflow steps, such as automated model testing and deployment, based on an event in W&B, such as when an [artifact](/guides/artifacts/) artifact version is created or when a [run metric](/guides/runs/) meets or changes by a threshold.
...
## Overview
An automation can start when a specific [event](/guides/automations/automation-events/) occurs in a registry or project.

In a [Registry](/guides/registry/), an automation can start:
...
In a [project](/guides/track/project-page/), an automation can start:
...
## Limitations
[Run metric automations](/guides/automations/automation-events/#run-metrics-events) are currently supported only in [W&B Multi-tenant Cloud](/guides/hosting/#wb-multi-tenant-cloud).

## Next steps
- [Create an automation](/guides/automations/create-automations/).
- Learn about [Automation events and scopes](/guides/automations/automation-events/).
