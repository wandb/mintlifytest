...
- [Developer documentation](../integrations/inference.mdx)
...
![Screenshot of Open in Playground button](/guides/tools/imgs/open_chat_in_playground.png)
...
![Screenshot of Playground settings](/guides/tools/imgs/playground_settings.png)
...
![Screenshot of Playground message buttons](/guides/tools/imgs/playground_message_buttons.png)
![Screenshot of Playground editing](/guides/tools/imgs/playground_message_editor.png)
...
![Screenshot of Playground sending a message](/guides/tools/imgs/playground_chat_input.png)
...
![Saving a model in the Playground](/guides/tools/imgs/saved-model.png)
...
![The LLM dropdown, with Saved Models selected](/guides/tools/imgs/saved-models-dropdown.png)
