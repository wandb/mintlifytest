...
- [`wandb.init()`](/ref/python/functions/init): Create a [run](/guides/runs/) to track results.
...
## How to get started
* [Quickstart](/guides/tables/tables-walkthrough/): Learn to log data tables, visualize data, and query data.
* [Tables Gallery](/guides/tables/tables-gallery/): See example use cases for Tables.