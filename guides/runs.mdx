...
When runs are part of a [sweep](/guides/sweeps/), their states behave independently from the sweep's status:
...
For a detailed explanation of how sweep and run statuses interact, see [Understanding sweep and run statuses](/guides/sweeps/pause-resume-and-cancel-sweeps#understanding-sweep-and-run-statuses).
