...
![Screenshot of viewing a prompt object](/guides/core-types/imgs/prompt-object.png)

I can also select them for comparison to see exactly what changed.

![Screenshot of prompt comparison](/guides/core-types/imgs/prompt-comparison.png)
