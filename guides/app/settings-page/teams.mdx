...
4. To configure your team, refer to [Manage team settings](/guides/app/settings-page/team-settings/).
...
- **Member**: A regular member of the team. By default, only an admin can invite a team member. To change this behavior, refer to [Manage team settings](/guides/app/settings-page/team-settings/).
