...
* **Point aggregation method**. Either **Random sampling** (the default) or **Full fidelity**. Refer to [Sampling](/guides/app/features/panels/line-plot/sampling/).
...
Use [Automations](/guides/automations/) to notify your team when a run metric meets a condition you specify. An automation can post to a Slack channel or run a webhook.

From a line plot, you can quickly create a [run metrics notification](/guides/automations/automation-events/#run-events) for the metric it shows:
...
Learn more about [Automations](/guides/automations/).

## Visualize CoreWeave infrastructure alerts

Observe infrastructure alerts such as GPU failures, thermal violations, and more during machine learning experiments you log to W&B. During a [W&B run](/guides/runs/), [CoreWeave Mission Control](https://www.coreweave.com/mission-control) monitors your compute infrastructure.
...
<Tip>
To views runs with infrastructure issues at a glance, pin the **Issues** column to your W&B Workspace to view runs that logged an issue at a glance. For more information about how to pin a column, see [Customize how runs are displayed](/guides/runs/#customize-how-runs-are-displayed).
</Tip>
