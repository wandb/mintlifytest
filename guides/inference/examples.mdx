...
Before running this example, complete the [prerequisites](/guides/inference/prerequisites/).
...
- Explore the [API reference](/guides/inference/api-reference/) for all available methods
- Try models in the [UI](/guides/inference/ui-guide/)
