...
Learn how to use the W&B Inference service through the web UI. Before using the UI, complete the [prerequisites](/guides/inference/prerequisites/).
...
- Try the [API](/guides/inference/api-reference/) for programmatic access
- See [usage examples](/guides/inference/examples/) for code samples 