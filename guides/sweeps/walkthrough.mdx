...
Specify the hyperparameters to sweep in a dictionary. For configuration options, see [Define sweep configuration](/guides/sweeps/define-sweep-configuration/).
...
Open your project to see your live results in the W&B App dashboard. With just a few clicks, construct rich, interactive charts like [parallel coordinates plots](/guides/app/features/panels/parallel-coordinates/),[ parameter importance analyzes](/guides/app/features/panels/parameter-importance/), and [additional chart types](/guides/app/features/panels/).
