...
[`WeaveObject`](WeaveObject.mdx).[`constructor`](WeaveObject.mdx#constructors)
...
[`WeaveObject`](WeaveObject.mdx).[`__savedRef`](WeaveObject.mdx#__savedref)
...
[`WeaveObject`](WeaveObject.mdx).[`_baseParameters`](WeaveObject.mdx#_baseparameters)
...
[`WeaveObject`](WeaveObject.mdx).[`description`](WeaveObject.mdx#description)
...
[`WeaveObject`](WeaveObject.mdx).[`id`](WeaveObject.mdx#id)
...
[`WeaveObject`](WeaveObject.mdx).[`className`](WeaveObject.mdx#classname)
...
[`WeaveObject`](WeaveObject.mdx).[`saveAttrs`](WeaveObject.mdx#saveattrs)
