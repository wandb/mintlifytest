...
[weave](/reference/typescript-sdk/weave/index) / Dataset
...
> **new Dataset**\<`R`\>(`parameters`): [`Dataset`](/reference/typescript-sdk/weave/classes/Dataset)\<`R`\>
...
[`Dataset`](/reference/typescript-sdk/weave/classes/Dataset)\<`R`\>
