...
[weave](/reference/typescript-sdk/weave/index) / WeaveClient
...
> **new WeaveClient**(`traceServerApi`, `wandbServerApi`, `projectId`, `settings`): [`WeaveClient`](/reference/typescript-sdk/weave/classes/WeaveClient)
...
> **getCalls**(`filter`, `includeCosts`, `limit`): `Promise`\<[`CallSchema`](/reference/typescript-sdk/weave/interfaces/CallSchema)[]\>

#### Parameters

• **filter**: [`CallsFilter`](/reference/typescript-sdk/weave/interfaces/CallsFilter) = `{}`
...
`Promise`\<[`CallSchema`](/reference/typescript-sdk/weave/interfaces/CallSchema)[]\>
...
> **getCallsIterator**(`filter`, `includeCosts`, `limit`): `AsyncIterableIterator`\<[`CallSchema`](/reference/typescript-sdk/weave/interfaces/CallSchema)\>
...
`AsyncIterableIterator`\<[`CallSchema`](/reference/typescript-sdk/weave/interfaces/CallSchema)\>
...
• **op**: [`Op`](/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `any`\>
