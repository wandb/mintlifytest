...
> **op**\<`T`\>(`fn`, `options`?): [`Op`](/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`T`\>\>\>\>
...
[`Op`](/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`T`\>\>\>\>
...
> **op**\<`T`\>(`thisArg`, `fn`, `options`?): [`Op`](/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`T`\>\>\>\>
