...
Refer to the [reference architecture](/guides/hosting/self-managed/ref-arch/#infrastructure-requirements). In addition, [obtain a valid W&B Server license](../#obtain-your-wb-server-license).

See the [bare-metal installation guide](/guides/hosting/self-managed/bare-metal/) for a detailed explanation on how to set up and configure a self-managed installation.
...
See the [Deploy W&B in airgapped environment with Kubernetes](/guides/hosting/self-managed/operator-airgapped/) tutorial on how to install the W&B Kubernetes Operator in an airgapped environment.
...
For a detailed description of the migration process,  continue [here](/modules/wandb/wandb/helm/latest).
