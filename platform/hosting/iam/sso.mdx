...
You can use environment variables to [configure IAM options](/guides/hosting/iam/advanced_env_vars/) for your [Dedicated cloud](/guides/hosting/hosting-options/dedicated_cloud) or [Self-managed](/guides/hosting/hosting-options/self-managed) instance.
...
The System Console is the successor to the System Settings page. It is available with the [W&B Kubernetes Operator](/guides/hosting/operator/) based deployment.

1. Refer to [Access the W&B Management Console](/guides/hosting/operator/#access-the-wb-management-console).
