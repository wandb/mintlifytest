...
To fully remove a deactivated user from the user list, you must [remove the user from the organization](/guides/hosting/iam/access-management/manage-organization/#remove-a-user).
