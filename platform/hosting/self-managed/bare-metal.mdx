...
Before you start deploying W&B, refer to the [reference architecture](/guides/hosting/self-managed/ref-arch/#infrastructure-requirements), especially the infrastructure requirements.
...
The recommended installation method is with the official W&B Helm chart. Follow the [Helm CLI deployment section](/guides/hosting/operator/#deploy-wb-with-helm-cli) to deploy the W&B Server application.
