...
<Note>
The transition to a Kubernetes [operator](https://kubernetes.io/docs/concepts/extend-kubernetes/operator/) pattern is necessary for the W&B architecture. See the [architecture shift explanation](/guides/hosting/operator/#reasons-for-the-architecture-shift) for a detailed explanation.
</Note>
