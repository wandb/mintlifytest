...
| Export reports | [Report and Workspace API](/guides/reports/clone-and-export-reports/) |
...
If you manage artifacts stored in the Dedicated cloud with [Secure Storage Connector](/guides/app/settings-page/teams/#secure-storage-connector), you may not need to export the artifacts using the W&B SDK API.
