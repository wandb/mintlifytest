...
You can bring your own bucket (BYOB) using the [secure storage connector](/guides/hosting/data-security/secure-storage-connector) at the [instance and team levels](/guides/hosting/data-security/secure-storage-connector#configuration-options) to store your files such as models, datasets, and more.
