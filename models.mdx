...
- [Maintain a centralized hub of all models](/guides/registry/), with a seamless handoff point to devops and deployment
- Configure custom automations that trigger key workflows for [model CI/CD](/guides/automations/).
