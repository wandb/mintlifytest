...
<Tabs>
<Tab title="커맨드라인">
1. `WANDB_API_KEY` [환경 변수](/ko/guides/track/environment-variables/)를 설정합니다.
...
[Run](/ko/guides/runs/)은 W&B의 핵심 요소로, [메트릭 추적](/ko/guides/track/), [로그 생성](/ko/guides/track/log/) 등에 사용됩니다.
...
2. [W&B Reports](/ko/guides/reports/)를 사용하여 runs을 구성하고, 시각화를 자동화하고, 발견한 내용을 요약하고, 협업자와 업데이트를 공유합니다.
3. [W&B Artifacts](/ko/guides/artifacts/)를 생성하여 기계 학습 파이프라인 전체에서 데이터셋, Models, 종속성 및 결과를 추적합니다.
4. [W&B Sweeps](/ko/guides/sweeps/)로 하이퍼파라미터 검색을 자동화하고 Models을 최적화합니다.
