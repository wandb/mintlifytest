...
1. [W&B run](/ko/guides/runs/)을 초기화하고 추적하려는 하이퍼파라미터를 전달합니다.
...
W&B run은 자동으로 [메트릭](/ko/guides/runs/#workspace-tab),
시스템 정보,
[하이퍼파라미터](/ko/guides/runs/#overview-tab),
[터미널 출력](/ko/guides/runs/#logs-tab)을 기록하고
...
Python 코드에서 Slack 또는 이메일로 알림을 보내도록 [W&B Alerts](/ko/guides/runs/alert/)를 만듭니다.
...
[여기에서 W&B Alerts에 대한 전체 문서를 찾을 수 있습니다](/ko/guides/runs/alert/).
