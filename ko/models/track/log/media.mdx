...
히스토그램이 요약에 있으면 [Run 페이지](/ko/guides/runs/)의 Overview 탭에 나타납니다. 히스토리가 있으면 차트 탭에서 시간 경과에 따른 구간의 히트맵이 플롯됩니다.
...
W&B [Run](/ko/guides/runs/) 및 [Project](/ko/guides/track/project-page/) 페이지에서 미디어 섹션에 비디오가 표시됩니다.
