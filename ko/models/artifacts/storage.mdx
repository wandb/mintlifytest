...
민감한 파일의 경우, [Private Hosting](/ko/guides/hosting/)을 설정하거나 [reference artifacts](/ko/guides/artifacts/track-external-files/)를 사용하는 것이 좋습니다.
...
환경 변수를 사용하여 W&B를 구성하는 방법에 대한 전체 가이드는 [환경 변수 참조](/ko/guides/track/environment-variables/)를 참조하십시오.
