...
<Note>
위의 코드 조각과 이 페이지에 링크된 colab은 W&B CLI로 스윕을 초기화하고 생성하는 방법을 보여줍니다. 스윕 구성을 정의하고 스윕을 초기화하고 스윕을 시작하는 데 사용할 W&B Python SDK 명령에 대한 단계별 개요는 Sweeps [WalkThrough](/ko/guides/sweeps/walkthrough/)를 참조하세요.
</Note>
...
* 스윕 구성을 정의하고 스윕을 초기화하고 스윕을 시작하는 데 사용할 W&B Python SDK 명령에 대한 단계별 개요는 [스윕 워크스루](/ko/guides/sweeps/walkthrough/)를 읽어보세요.
* 다음 방법을 배우려면 이 챕터를 살펴보세요.
  * [W&B를 코드에 추가](/ko/guides/sweeps/add-w-and-b-to-your-code/)
  * [스윕 구성 정의](/ko/guides/sweeps/define-sweep-configuration/)
  * [스윕 초기화](/ko/guides/sweeps/initialize-sweeps/)
  * [스윕 에이전트 시작](/ko/guides/sweeps/start-sweep-agents/)
  * [스윕 결과 시각화](/ko/guides/sweeps/visualize-sweep-results/)
* W&B Sweeps를 사용한 하이퍼파라미터 최적화를 탐색하는 [선별된 스윕 Experiments 목록](/ko/guides/sweeps/useful-resources/)을 탐색합니다. 결과는 W&B Reports에 저장됩니다.
