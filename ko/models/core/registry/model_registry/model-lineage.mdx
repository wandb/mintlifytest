...
이 페이지에서는 기존 W&B Model Registry에서 계보 그래프를 생성하는 방법을 설명합니다. W&B Registry의 계보 그래프에 대해 자세히 알아보려면 [계보 맵 생성 및 보기](/ko/guides/core/registry/lineage/)를 참조하세요.

<Note>
W&B는 기존 [W&B Model Registry](/ko/guides/core/registry/model_registry/)의 자산을 새로운 [W&B Registry](/ko/./)로 이전할 예정입니다. 이 마이그레이션은 W&B에서 완전히 관리하고 트리거하며, 사용자의 개입이 필요하지 않습니다. 이 프로세스는 기존 워크플로우에 대한 중단을 최소화하면서 최대한 원활하게 진행되도록 설계되었습니다. [기존 Model Registry에서 마이그레이션](/ko/guides/core/registry/model_registry_eol/)을 참조하세요.
</Note>
