...
W&B Python SDK를 사용하여 대화형 및 프로그래밍 방식으로 리포트를 만드는 방법에 대한 자세한 내용은 [리포트 만들기](/ko/./create-a-report) 페이지를 참조하세요.
...
* 라이브 리포트의 예는 [Reports 갤러리](/ko/./reports-gallery)를 탐색해 보세요.
