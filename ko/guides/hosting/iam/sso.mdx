...
환경 변수를 사용하여 [IAM 옵션 구성](/ko/../advanced_env_vars)을 [전용 클라우드](/ko/guides/hosting/hosting-options/dedicated_cloud) 또는 [자체 관리형](/ko/guides/hosting/hosting-options/self-managed) 인스턴스에 설정할 수 있습니다.
...
시스템 콘솔은 시스템 설정 페이지의 후속 버전입니다. [W&B Kubernetes Operator](/ko/guides/hosting/hosting-options/self-managed/kubernetes-operator/) 기반 배포에서 사용할 수 있습니다.

1. [W&B 관리 콘솔 엑세스](/ko/guides/hosting/hosting-options/self-managed/kubernetes-operator/#access-the-wb-management-console)를 참조하세요.
