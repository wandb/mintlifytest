...
* 조직 이메일 도메인이 일치하는 사용자가 이 팀에 참여하도록 허용합니다.
    * 이 설정은 [SaaS Cloud](/ko/guides/hosting/hosting-options/saas_cloud/)에만 적용됩니다. [Dedicated Cloud](/ko/guides/hosting/hosting-options/dedicated_cloud/) 또는 [Self-managed](/ko/guides/hosting/hosting-options/self-managed/) 인스턴스에서는 사용할 수 없습니다.
* 코드 저장을 기본적으로 활성화합니다.
...
* 향후 Projects에 대한 개인 정보 보호 적용
    * 이 옵션을 활성화하면 모든 팀의 향후 모든 Projects가 비공개 또는 [restricted](/ko/guides/hosting/iam/access-management/restricted-projects/)되도록 적용합니다.
* 초대 제어 적용
