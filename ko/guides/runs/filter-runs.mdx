...
정규식으로 원하는 결과를 얻을 수 없는 경우, [태그](/ko/guides/runs/tags/)를 사용하여 Runs Table에서 run을 필터링할 수 있습니다. 태그는 run 생성 시 또는 완료 후에 추가할 수 있습니다. 태그가 run에 추가되면 아래 GIF와 같이 태그 필터를 추가할 수 있습니다.
