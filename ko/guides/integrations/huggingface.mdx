...
[Artifacts](/ko/guides/artifacts/)를 사용하면 최대 100GB의 Models 및 Datasets를 무료로 저장한 다음 Weights & Biases [Registry](/ko/guides/core/registry/)를 사용할 수 있습니다. Registry를 사용하면 Models를 등록하여 탐색하고 평가하고, 스테이징을 준비하거나 프로덕션 환경에 배포할 수 있습니다.
...
트레이닝 결과를 로깅했으면 [W&B Dashboard](/ko/guides/track/workspaces/)에서 결과를 동적으로 탐색할 수 있습니다. 유연하고 대화형 시각화를 통해 한 번에 수십 개의 Runs를 비교하고, 흥미로운 발견을 확대하고, 복잡한 데이터에서 통찰력을 얻는 것이 쉽습니다.
