...
자동화에 대해 자세히 알아보려면 [자동화 개요](/ko/guides/core/automations/) 또는 [자동화 생성](/ko/create-automations/)을 참조하세요.
...
[자동화 생성](/ko/create-automations/)에 대해 자세히 알아보세요.
...
## Project
이 섹션에서는 [project](/ko/guides/models/track/project-page)의 자동화에 대한 범위와 이벤트에 대해 설명합니다.
...
## 다음 단계
- [Slack 자동화 생성](/ko/create-automations/slack)
- [Webhook 자동화 생성](/ko/create-automations/webhook)
