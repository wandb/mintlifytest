...
Amazon S3에 저장된 파일과 같은 외부 파일을 추적하는 방법에 대한 자세한 내용은 [외부 파일 추적](/ko/guides/artifacts/track-external-files/) 페이지를 참조하세요.
...
자세한 내용은 [Artifact 그래프 탐색 및 트래버스](/ko/guides/artifacts/explore-and-traverse-an-artifact-graph/)를 참조하세요.
</Note>
...
[`add_dir`](/ko/ref/python/artifact#add_dir) 메소드를 사용하여 여러 파일을 추가할 수도 있습니다. 파일을 추가하는 방법에 대한 자세한 내용은 [Artifact 업데이트](/ko/guides/artifacts/update-an-artifact/)를 참조하세요.
...
선택적으로 W&B Run 외부에서 Artifact를 구성할 수 있습니다. 자세한 내용은 [외부 파일 추적](/ko/guides/artifacts/track-external-files/)을 참조하세요.
