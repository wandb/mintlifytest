...
W&B가 처리하는 방법을 아는 스키마가 있는 참조는 Artifact 파일처럼 다운로드됩니다. 자세한 내용은 [외부 파일 추적](/ko/guides/artifacts/track-external-files/)을 참조하세요.
</Tab>
<Tab title="Run 외부">
...
Artifact 구성에 대한 자세한 내용은 [Artifact 구성](/ko/guides/artifacts/construct-an-artifact/)을 참조하세요.
