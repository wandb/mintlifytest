...
* [**Overview**](/ko/guides/track/project-page/#overview-tab): 프로젝트의 스냅샷
* [**Workspace**](/ko/guides/track/project-page/#workspace-tab): 개인 시각화 샌드박스
* [**Runs**](#runs-tab): 프로젝트의 모든 run을 나열하는 테이블
* **Automations**: 프로젝트에서 구성된 자동화
* [**Sweeps**](/ko/guides/track/project-page/#sweeps-tab): 자동화된 탐색 및 최적화
* [**Reports**](/ko/guides/track/project-page/#reports-tab): 노트, run 및 그래프의 저장된 스냅샷
...
프로젝트에서 새 [sweep](/ko/guides/sweeps/)을 시작합니다.
...
트레이닝 데이터셋 및 [파인튜닝된 Models](/ko/guides/core/registry/)에서 [메트릭 및 미디어 테이블](/ko/guides/models/tables/tables-walkthrough/)에 이르기까지 프로젝트와 연결된 모든 [Artifacts](/ko/guides/track/project-page/#artifacts-tab)를 봅니다.
