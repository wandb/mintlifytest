...
experiment를 구성하는 방법에 대한 자세한 내용은 [Experiments 구성](/ko/guides/track/config/)을 참조하십시오.
...
W&B로 기록할 수 있는 다양한 데이터 유형에 대한 자세한 내용은 [Experiments 중 데이터 기록](/ko/guides/track/log/)을 참조하십시오.
...
```
[Artifacts](/ko/guides/artifacts/) 또는 [Registry](/ko/guides/core/registry/)에서 Models 버전 관리에 대해 자세히 알아보십시오.
...
W&B Dashboard를 기계 학습 모델의 결과를 구성하고 시각화하는 중앙 장소로 사용하십시오. 몇 번의 클릭만으로 [평행 좌표 플롯](/ko/guides/app/features/panels/parallel-coordinates/), [파라미터 중요도 분석](/ko/guides/app/features/panels/parameter-importance/) 및 [기타](/ko/guides/app/features/panels/)와 같은 풍부한 인터랙티브 차트를 구성합니다.

<Frame>
    <img src="/images/sweeps/quickstart_dashboard_example.png" alt="Quickstart Sweeps Dashboard example"  />
</Frame>

Experiments 및 특정 runs를 보는 방법에 대한 자세한 내용은 [Experiments 결과 시각화](/ko/guides/track/workspaces/)를 참조하십시오.
