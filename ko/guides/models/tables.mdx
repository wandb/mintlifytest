...
## 시작 방법
* [퀵스타트](/ko/guides/models/tables/tables-walkthrough/): 데이터 table 기록, 데이터 시각화 및 데이터 쿼리에 대해 알아봅니다.
* [Tables Gallery](/ko/guides/models/tables/tables-gallery/): Tables의 유스 케이스 예시를 확인하세요.
