...
5. **Job version** 드롭다운에서 사용하려는 launch job 버전을 선택합니다. Launch job은 다른 [W&B Artifact](/ko/guides/artifacts/create-a-new-artifact-version)처럼 버전이 관리됩니다. job을 실행하는 데 사용되는 소프트웨어 종속성 또는 소스 코드를 수정하면 동일한 launch job의 다른 버전이 생성됩니다.
