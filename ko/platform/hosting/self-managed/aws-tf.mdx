...
<Note>
Kubernetes [operator](https://kubernetes.io/docs/concepts/extend-kubernetes/operator/) 패턴으로의 전환은 W&B 아키텍처에 필요합니다. 아키텍처 변경에 대한 자세한 설명은 [이 섹션](/ko/guides/hosting/operator/#reasons-for-the-architecture-shift)을 참조하세요.
</Note>
