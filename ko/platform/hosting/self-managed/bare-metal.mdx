...
W&B 배포를 시작하기 전에 [참조 아키텍처](/ko/guides/hosting/self-managed/ref-arch/#infrastructure-requirements), 특히 인프라 요구 사항을 참조하십시오.
...
권장되는 설치 방법은 공식 W&B Helm 차트를 사용하는 것입니다. [이 섹션](/ko/guides/hosting/operator/#deploy-wb-with-helm-cli)에 따라 W&B Server 애플리케이션을 배포하십시오.
