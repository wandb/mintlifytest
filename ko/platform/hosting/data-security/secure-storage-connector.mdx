...
<Note>
* W&B SDK / CLI / UI와 버킷 간의 통신은 [사전 서명된 URL](/ko/guides/hosting/data-security/presigned-urls/)을 사용하여 이루어집니다.
* W&B는 가비지 컬렉션 프로세스를 사용하여 W&B Artifacts를 삭제합니다. 자세한 내용은 [Artifacts 삭제](/ko/guides/artifacts/delete-artifacts/)를 참조하세요.
...
2. S3 버킷 프로비저닝
    ...
    5. 클라우드 인프라 또는 사용자 브라우저의 AI 워크로드가 버킷에 엑세스하는 데 사용하는 [사전 서명된 URL](/ko/guides/hosting/data-security/presigned-urls/)을 생성하는 데 필요한 권한인 W&B 플랫폼을 호스팅하는 AWS 계정에 필요한 S3 권한을 부여합니다.
  ...
  자세한 내용은 [AWS 자체 관리 호스팅 가이드](/ko/guides/hosting/self-managed/aws-tf/)를 참조하십시오.
</Tab>
<Tab title="GCP">
1. GCS 버킷 프로비저닝
