...
menu:
  default:
    ...
    parent: self-managed
slug: /ko/guides/hosting/operator
weight: 2
---
...
[참조 아키텍처](/ko/guides/hosting/self-managed/ref-arch/#infrastructure-requirements)를 참조하세요. 또한 [유효한 W&B Server 라이선스를 획득하세요](/#obtain-your-wb-server-license).

자체 관리 설치를 설정하고 구성하는 방법에 대한 자세한 설명은 [이](/ko/guides/hosting/self-managed/bare-metal/) 가이드를 참조하세요.
...
### 에어 갭 설치
에어 갭 환경에 W&B Kubernetes Operator를 설치하는 방법은 [Kubernetes를 사용하여 에어 갭 환경에 W&B 배포](/ko/guides/hosting/self-managed/operator-airgapped/) 튜토리얼을 참조하세요.
...
마이그레이션 프로세스에 대한 자세한 설명은 [여기](/ko/guides/hosting/operator/#deploy-wb-with-helm-cli)를 계속 진행하세요.
