...
![Side-by-side Comparison view of two objects](/guides/tools/imgs/comparison-2objs-sidebyside.png)
...
![Unified Comparison view of two objects](/guides/tools/imgs/comparison-2objs-unified.png)
...
2. Click the three dots to the right of the ID.
   ![Make baseline option displayed.](/guides/tools/imgs/comparison-2objs-baseline.png)
3. In the dropdown, select **Make baseline**. The UI refreshes so that the baseline object is furthest left in the topbar, and `Baseline` displays next to the ID.
    ![Baseline set.](/guides/tools/imgs/comparison-2objs-baseline-set.png)
...
2. Click the six dots to the left of the ID.
   ![Setting the order.](/guides/tools/imgs/comparison-2objs-reorder.png)
...
1. In the Comparison table, find the numeric value that you want to update the diff display format for.
    ![A numeric value displayed as an integer.](/guides/tools/imgs/comparison-2objs-numericdiffformat.png)
2. Click the diff value. The format automatically updates to either an integer or a percentage.
    ![A numeric value updated to a percentage.](/guides/tools/imgs/comparison-2objs-numericdiffformat-updated.png)
...
2. To select the item, click the ID. The UI refreshes with a two-way comparison table.
    ![Comparing a pair from a multi-object comparison.](/guides/tools/imgs/comparsion-7objs-diffonly-subset.png)
