...
```python
thread(
    thread_id: 'str | None | object' = <object object at 0x7fad47444e10>
...
- `scorers`: `typing.Optional[list[typing.Annotated[typing.Union[trace.op_protocol.Op, flow.scorer.Scorer], BeforeValidator(func=<function cast_to_scorer at 0x7fad47295b20>, json_schema_input_type=PydanticUndefined)]]]`
