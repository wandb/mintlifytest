...
```python
thread(
    thread_id: 'str | None | object' = <object object at 0x7f258d901510>
...
- `scorers`: `typing.Optional[list[typing.Annotated[typing.Union[trace.op.Op, flow.scorer.Scorer], BeforeValidator(func=<function cast_to_scorer at 0x7f258d3b05e0>, json_schema_input_type=PydanticUndefined)]]]`
