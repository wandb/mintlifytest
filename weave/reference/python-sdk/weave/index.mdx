...
```python
thread(
    thread_id: 'str | None | object' = <object object at 0x7f9fb01b8e10>
...
- `scorers`: `typing.Optional[list[typing.Annotated[typing.Union[trace.op_protocol.Op, flow.scorer.Scorer], BeforeValidator(func=<function cast_to_scorer at 0x7f9fb0011b20>, json_schema_input_type=PydanticUndefined)]]]`
