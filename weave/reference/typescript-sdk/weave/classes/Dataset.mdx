...
[weave](/weave/reference/typescript-sdk/weave/index) / Dataset
...
> **new Dataset**\<`R`\>(`parameters`): [`Dataset`](/weave/reference/typescript-sdk/weave/classes/Dataset)\<`R`\>
...
[`Dataset`](/weave/reference/typescript-sdk/weave/classes/Dataset)\<`R`\>
