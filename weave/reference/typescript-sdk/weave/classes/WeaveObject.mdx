...
[weave](/weave/reference/typescript-sdk/weave/index) / WeaveObject
...
> **new WeaveObject**(`_baseParameters`): [`WeaveObject`](/weave/reference/typescript-sdk/weave/classes/WeaveObject)
