...
[weave](/weave/reference/typescript-sdk/weave/index) / WeaveClient
...
> **new WeaveClient**(`traceServerApi`, `wandbServerApi`, `projectId`, `settings`): [`WeaveClient`](/weave/reference/typescript-sdk/weave/classes/WeaveClient)
...
> **getCalls**(`filter`, `includeCosts`, `limit`): `Promise`\<[`CallSchema`](/weave/reference/typescript-sdk/weave/interfaces/CallSchema)[]\>

#### Parameters

• **filter**: [`CallsFilter`](/weave/reference/typescript-sdk/weave/interfaces/CallsFilter) = `{}`
...
`Promise`\<[`CallSchema`](/weave/reference/typescript-sdk/weave/interfaces/CallSchema)[]\>
...
> **getCallsIterator**(`filter`, `includeCosts`, `limit`): `AsyncIterableIterator`\<[`CallSchema`](/weave/reference/typescript-sdk/weave/interfaces/CallSchema)\>
...
`AsyncIterableIterator`\<[`CallSchema`](/weave/reference/typescript-sdk/weave/interfaces/CallSchema)\>
...
• **op**: [`Op`](/weave/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `any`\>
