...
[weave](/weave/reference/typescript-sdk/weave/index) / op

# Function: op()

## op(fn, options)

> **op**\<`T`\>(`fn`, `options`?): [`Op`](/weave/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`T`\>\>\>\>
...
[`Op`](/weave/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`T`\>\>\>\>
...
> **op**\<`T`\>(`thisArg`, `fn`, `options`?): [`Op`](/weave/reference/typescript-sdk/weave/type-aliases/Op)\<(...`args`) => `Promise`\<`Awaited`\<`ReturnType`\<`T`\>\>\>\>
