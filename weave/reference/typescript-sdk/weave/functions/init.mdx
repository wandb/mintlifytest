...
[weave](/weave/reference/typescript-sdk/weave/index) / init

# Function: init()

> **init**(`project`, `settings`?): `Promise`\<[`WeaveClient`](/weave/reference/typescript-sdk/weave/classes/WeaveClient)\>
...
`Promise`\<[`WeaveClient`](/weave/reference/typescript-sdk/weave/classes/WeaveClient)\>
