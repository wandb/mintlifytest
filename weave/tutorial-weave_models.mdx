...
<<<<<<< HEAD
<Frame>
![Re-using a weave model](/weave/images/tutorial-model_invoke3.png)
</Frame>
=======
![Re-using a weave model](/images/tutorial-model_invoke3.png)
>>>>>>> origin/feature/reference-docs-generation-v2
...
<Frame>
![Re-using a weave model](/weave/images/tutorial-model_re-use.png)
</Frame>
