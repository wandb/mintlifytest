...
Here we add a custom cost, and now that you have a custom cost, and our calls have usage, you can fetch the calls with `include_cost` and our calls with have costs under `summary.weave.costs`.
