...
We set the project in W&B you want to log this into in `name_of_wandb_project`.
...
Here we add a custom cost, and now that you have a custom cost, and your calls have usage, you can fetch the calls with `include_cost` and your calls with have costs under `summary.weave.costs`.
