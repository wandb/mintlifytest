...
In this tutorial, this tutorial will use a custom chatbot as an example app from which to collect user feedback.
This tutorial will use Streamlit to build the interface and we'll capture the LLM interactions and feedback in Weave.
...
You can use it as usual to deliver some model response to the user:
