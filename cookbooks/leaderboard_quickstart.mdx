...
In this notebook you learn to use Weave's Leaderboard to compare model performance across different datasets and scoring functions. Specifically, you:
...
First you create a function `generate_dataset_rows` that generates a list of fake zip code data.
...
Next you author 3 scoring functions:
...
Now you evaluate a baseline model which returns a static response.
...
Now you create 2 more models to compare against the baseline.
...
Now you evaluate a matrix of models vs evaluations.
