...
In this notebook you will learn to use Weave's Leaderboard to compare model performance across different datasets and scoring functions. Specifically, you will:
...
First you will create a function `generate_dataset_rows` that generates a list of fake zip code data.
...
Next you will author 3 scoring functions:
...
Now you will evaluate a baseline model which returns a static response.
...
Now you will create 2 more models to compare against the baseline.
...
Now you will evaluate a matrix of models vs evaluations.
