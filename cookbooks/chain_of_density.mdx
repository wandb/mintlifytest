...
In this tutorial, this tutorial will use Weave to implement and evaluate a Chain of Density summarization pipeline for ArXiv papers. You'll learn how to:
...
This tutorial will create a simple `ArxivPaper` class to represent the data:
...
To evaluate our pipeline, this tutorial will create a Weave Dataset and run an evaluation:
