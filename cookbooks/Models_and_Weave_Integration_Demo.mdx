...
class UnslothLoRAChatModel(weave.Model):
    """
    You define an extra ChatModel class to be able store and version more parameters than just the model name.
    ...
    def model_post_init(self, __context):
        # you can simply paste this from the "Use" tab from the registry
...
```python
# MAGIC: you can simply get an evaluation with a eval dataset and scorers and use them
