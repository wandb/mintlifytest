...
This tutorial demonstrates how you can improve the performance of your LLM workflow implemented  on the **causal judgement task** from the BIG-bench Hard benchmark and evaluate your prompting strategies. You will use [DSPy](https://dspy-docs.vercel.app/) for implementing your LLM workflow and optimizing your prompting strategy. You will also use [Weave](https://docs.wandb.ai/guides/weave) to track your LLM workflow and evaluate your prompting strategies.
...
Since we'll be using [OpenAI API](https://openai.com/index/openai-api/) as the LLM Vendor, you will also need an OpenAI API key. You can [sign up](https://platform.openai.com/signup) on the OpenAI platform to get your own API key.
...
You will load this dataset from HuggingFace Hub, split into training and validation sets, and [publish](https://docs.wandb.ai/guides/weave/core-types/datasets) them on Weave, this will let you version the datasets, and also use [`weave.Evaluation`](https://docs.wandb.ai/guides/weave/core-types/evaluations) to evaluate your prompting strategy.
...
You will use the [`dspy.OpenAI`](https://dspy-docs.vercel.app/api/language_model_clients/OpenAI) abstraction to make LLM calls to [GPT3.5 Turbo](https://platform.openai.com/docs/models/gpt-3-5-turbo).
