...
This tutorial demonstrates how you can improve the performance of our LLM workflow implemented  on the **causal judgement task** from the BIG-bench Hard benchmark and evaluate our prompting strategies. You will use [DSPy](https://dspy-docs.vercel.app/) for implementing our LLM workflow and optimizing our prompting strategy. You will also use [Weave](https://docs.wandb.ai/guides/weave) to track our LLM workflow and evaluate our prompting strategies.
...
In this tutorial, you use a metadata class inherited from [`weave.Object`](/guides/tracking/objects) to manage our metadata.
...
Now that you have our optimized program (the optimized prompting strategy), let's evaluate it once again on our validation set and compare it with our baseline DSPy program.
