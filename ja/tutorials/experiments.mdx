...
1. [W&B run](/ja/guides/runs/) を初期化し、追跡したいハイパーパラメーターを渡します。
...
W&B run では自動で [メトリクス](/ja/guides/runs/#workspace-tab)、システム情報、[ハイパーパラメーター](/ja/guides/runs/#overview-tab)、[ターミナル出力](/ja/guides/runs/#logs-tab) をログし、モデルの入力と出力を含む [インタラクティブテーブル](/ja/guides/models/tables/) が表示されます。
...
[W&B アラート](/ja/guides/runs/alert/) を作成して、Python コードからあなたの Slack やメールにアラートを送信します。
...
[W&B アラートの完全なドキュメントはこちらで見つけることができます](/ja/guides/runs/alert/)。
