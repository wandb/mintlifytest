...
#### 戻り値
2 つの [数値](number) のモジュロ

<h3 id="number-mult"><code>number-mult</code></h3>

2 つの [数値](number) を掛け算します。
...
#### 戻り値
底の[数値](number)が n 乗された値

<h3 id="number-add"><code>number-add</code></h3>

2 つの [数値](number) を加えます。
...
1 つの [数値](number) が別の数値より小さいかどうかを確認します。
...
#### 戻り値
最初の [数値](number) が 2 番目の数値より小さいかどうか

<h3 id="number-lessEqual"><code>number-lessEqual</code></h3>

1 つの [数値](number) が別の数値以下であるかどうかを確認します。
...
#### 戻り値
最初の [数値](number) が 2 番目の数値以下であるかどうか
...
1 つの [数値](number) が別の数値より大きいかどうかを確認します。
...
#### 戻り値
最初の [数値](number) が 2 番目の数値より大きいかどうか

<h3 id="number-greaterEqual"><code>number-greaterEqual</code></h3>

1 つの [数値](number) が別の数値以上であるかどうかを確認します。
...
#### 戻り値
最初の [数値](number) が 2 番目の数値以上であるかどうか
...
[数値](number) を _タイムスタンプ_ に変換します。31536000000 未満の値は秒に、31536000000000 未満の値はミリ秒に、31536000000000000 未満の値はマイクロ秒に、31536000000000000000 未満の値はナノ秒に変換されます。
...
最大の [数値](number) のインデックスを見つけます。

| 引数 |  |
| :--- | :--- |
| `numbers` | 最大の [数値](number) のインデックスを見つけるための[数値](number)の_リスト_ |

#### 戻り値
最大の [数値](number) のインデックス

<h3 id="numbers-argmin"><code>numbers-argmin</code></h3>

最小の [数値](number) のインデックスを見つけます。

| 引数 |  |
| :--- | :--- |
| `numbers` | 最小の [数値](number) のインデックスを見つけるための[数値](number)の_リスト_ |

#### 戻り値
最小の [数値](number) のインデックス
...
| 引数 |  |
| :--- | :--- |
| `numbers` | 平均を取るための[数値](number)の_リスト_ |
...
| 引数 |  |
| :--- | :--- |
| `numbers` | 最大の [数値](number) を見つけるための[数値](number)の_リスト_ |
...
| 引数 |  |
| :--- | :--- |
| `numbers` | 最小の [数値](number) を見つけるための[数値](number)の_リスト_ |
...
| 引数 |  |
| :--- | :--- |
| `numbers` | 標準偏差を計算するための[数値](number)の_リスト_ |
...
| 引数 |  |
| :--- | :--- |
| `numbers` | 合計を求めるための[数値](number)の_リスト_ |
