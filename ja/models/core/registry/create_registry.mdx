...
<Info>
コアとカスタムレジストリの完全な比較は、[Registry types](/ja/guides/core/registry/registry_types/#summary)の概要表をご覧ください。
</Info>
...
5. **Registry visibility** ドロップダウンからレジストリを閲覧できる人を選択します。レジストリの公開範囲オプションの詳細については、[Registry visibility types](/ja/guides/core/registry/configure_registry/#registry-visibility-types)をご覧ください。
...
チーム管理者がそれを作成する際に、カスタムレジストリの公開範囲をどのように設定するかに関する詳細は [Create a custom registry](/ja/guides/core/registry/create_registry/#create-a-custom-registry) を参照してください。