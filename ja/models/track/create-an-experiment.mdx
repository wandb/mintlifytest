...
実験を設定する方法の詳細については、[Configure Experiments](/ja/guides/track/config/)を参照してください。
...
W&Bでログできるさまざまなデータタイプの詳細については、[Log Data During Experiments](/ja/guides/track/log/)を参照してください。
...
```
[Artifacts](/ja/guides/artifacts/)や[Registry](/ja/guides/core/registry/)でのモデルのバージョン管理について詳しく学んでください。
...
## 次のステップ：実験を可視化
W&Bダッシュボードを使用して、機械学習モデルの結果を整理し可視化する中央の場所として利用します。[parallel coordinates plots](/ja/guides/app/features/panels/parallel-coordinates/)、[parameter importance analyzes](/ja/guides/app/features/panels/parameter-importance/)、および[その他の](/ja/guides/app/features/panels/)ようなリッチでインタラクティブなグラフを数クリックで構築します。

<Frame>
    <img src="/images/sweeps/quickstart_dashboard_example.png" alt="クイックスタートスイープダッシュボードの例"  />
</Frame>

実験や特定runの表示方法についての詳細は、[Visualize results from experiments](/ja/guides/track/workspaces/)を参照してください。
