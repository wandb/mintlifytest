...
<Tabs>
<Tab title="コマンドライン">
1. `WANDB_API_KEY` [環境変数](/ja/guides/track/environment-variables/) を設定します。
...
W&B のコア要素として [ラン](/ja/guides/runs/) は使用され、[メトリクスをトラックする](/ja/guides/track/)、[ログを作成する](/ja/guides/track/log/) など様々なことができます。
...
2. [W&B Reports](/ja/guides/reports/) を使用して、ランを整理し、自動可視化し、学びを要約し、共同作業者と更新を共有します。
3. [W&B Artifacts](/ja/guides/artifacts/) を作成して、データセット、モデル、依存関係、および機械学習パイプライン全体の結果をトラックします。
4. [W&B Sweeps](/ja/guides/sweeps/) を使用してハイパーパラメーター検索を自動化し、モデルを最適化します。
