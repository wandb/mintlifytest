...
[リファレンスアーキテクチャ](/ja/guides/hosting/self-managed/ref-arch/#infrastructure-requirements)を参照してください。また、[有効な W&B サーバーライセンスを取得](/#obtain-your-wb-server-license)します。
...
エアギャップ環境での W&B Kubernetes オペレーターのインストール方法については、[Deploy W&B in airgapped environment with Kubernetes](/ja/guides/hosting/self-managed/operator-airgapped/) チュートリアルを参照してください。
...
移行プロセスの詳細な説明については、こちら [here](/ja/guides/hosting/self-managed/aws-tf/#migrate-to-operator-based-aws-terraform-modules)を参照してください。
