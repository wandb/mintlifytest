...
<Note>
Kubernetes [オペレーター](https://kubernetes.io/docs/concepts/extend-kubernetes/operator/) パターンへの移行は、W&B アーキテクチャーにとって必要です。アーキテクチャー変更の詳細な説明については[このセクション](/ja/guides/hosting/operator/#reasons-for-the-architecture-shift)を参照してください。
</Note>
