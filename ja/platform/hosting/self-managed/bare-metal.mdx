...
W&B のデプロイメントを開始する前に、特にインフラストラクチャー要件を確認するために、[リファレンスアーキテクチャー](/ja/guides/hosting/self-managed/ref-arch/#infrastructure-requirements)を参照してください。
...
公式の W&B Helm チャートを使用することが推奨されるインストール方法です。[こちらのセクション](/ja/guides/hosting/operator#deploy-wb-with-helm-cli)に従って W&B Server アプリケーションをデプロイしてください。
