...
基本的な[環境変数](/ja/guides/hosting/env-vars/)に加えて、環境変数を使用して、[専用クラウド](/ja/guides/hosting/hosting-options/dedicated_cloud)または[自己管理](/ja/guides/hosting/hosting-options/self-managed)インスタンスの IAM オプションを設定できます。
