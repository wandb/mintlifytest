...
1. [テーブルを作成する](/ja/./log-tables.md#create-tables)
2. [データを追加する](/ja/./log-tables.md#add-data)
3. [データを取得する](/ja/./log-tables.md#retrieve-data)
4. [テーブルを保存する](/ja/./log-tables.md#save-tables)
