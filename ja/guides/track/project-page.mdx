...
* [**Overview**](/ja/project-page#overview-tab): プロジェクトのスナップショット
* [**Workspace**](/ja/project-page#workspace-tab): 個人の可視化サンドボックス
* [**Runs**](#runs-tab): プロジェクト内のすべての run を一覧表示するテーブル
* **Automations**: プロジェクトで設定されたオートメーション
* [**Sweeps**](/ja/project-page#sweeps-tab): 自動探索と最適化
* [**Reports**](/ja/project-page#reports-tab): メモ、run、およびグラフの保存されたスナップショット
