...
* [**Overview**](/ja/guides/track/project-page/#overview-tab): プロジェクトのスナップショット
* [**Workspace**](/ja/guides/track/project-page/#workspace-tab): 個人の可視化サンドボックス
* [**Runs**](#runs-tab): プロジェクト内のすべての run を一覧表示するテーブル
* **Automations**: プロジェクトで設定されたオートメーション
* [**Sweeps**](/ja/guides/track/project-page/#sweeps-tab): 自動探索と最適化
* [**Reports**](/ja/guides/track/project-page/#reports-tab): メモ、run、およびグラフの保存されたスナップショット
...
[スイープ](/ja/guides/sweeps/)をプロジェクトから新たに開始します。
...
プロジェクトに関連付けられたすべての[Artifacts](/ja/guides/track/project-page/#artifacts-tab)をトレーニングデータセットや [ファインチューンされたモデル](/ja/guides/core/registry/)から[メトリクスやメディアのテーブル](/ja/guides/models/tables/tables-walkthrough/)まで表示します。
