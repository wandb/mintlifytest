...
Summary内にあるヒストグラムは、[Run Page](/ja/guides/runs/)のOverviewタブに表示されます。履歴にある場合、Chartsタブで時間経過によるビンのヒートマップをプロットします。
...
W&Bの[Run](/ja/guides/runs/)と[Project](/ja/guides/track/project-page/)ページで、メディアセクションにビデオが表示されます。
