...
* [機械学習タスクごとにベストなバージョンのモデルをブックマークする。](/ja/guides/core/registry/model_registry/link-model-version/)
...
* [モデルウォークスルー](/ja/guides/core/registry/model_registry/walkthrough/)を読み、W&B Python SDK コマンドを使用してデータセットアーティファクトを作成、追跡、および使用する手順を確認します。
* 以下について学ぶ：
  * [保護されたモデルとアクセス制御](/ja/guides/core/registry/model_registry/access_controls/)。
  * [CI/CD プロセスにレジストリを接続する方法](/ja/guides/core/automations/)。
  * 新しいモデルバージョンが登録済みモデルにリンクされたときの [Slack 通知を設定](/ja/guides/core/registry/model_registry/notifications/)。
