...
レジストリ管理者は、レジストリの設定を設定することで、[レジストリロールを設定](/ja/configure_registry#configure-registry-roles)、[ユーザーを追加](/ja/configure_registry#add-a-user-or-a-team-to-a-registry)、または[ユーザーを削除](/ja/configure_registry#remove-a-user-or-team-from-a-registry)することができます。
...
[レジストリでのユーザーロール設定](/ja/configure_registry#configure-registry-roles)や[レジストリロールの権限](/ja/configure_registry#registry-role-permissions)についての詳細をご覧ください。
...
レジストリ管理者は、レジストリ内のユーザーやチームのロールを割り当てまたは変更することができます。詳細は [レジストリでのユーザーロールの設定](/ja/configure_registry#configure-registry-roles) を参照してください。

<Note>
**W&Bロールタイプ**

W&B には、[チームロール](/ja/guides/models/app/settings-page/teams#team-role-and-permissions)と[レジストリロール](/ja/configure_registry#configure-registry-roles)の2種類のロールがあります。
