...
W&B には、[チームロール](/ja/guides/models/app/settings-page/teams.md#team-role-and-permissions)と[レジストリロール](/ja/configure_registry.md#configure-registry-roles)の2種類のロールがあります。
