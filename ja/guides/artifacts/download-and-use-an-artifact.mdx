...
W&B が処理方法を知っているスキームを持つ参照は、アーティファクトファイルと同様にダウンロードされます。詳細については、[Track external files](/ja/guides/artifacts/track-external-files/) を参照してください。
</Tab>
...
アーティファクトの構築に関する詳細については、[Construct an artifact](/ja/guides/artifacts/construct-an-artifact/) を参照してください。