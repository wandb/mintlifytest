...
機密性の高いファイルには、[プライベートホスティング](/ja/guides/hosting/)の設定や[参照アーティファクト](/ja/guides/artifacts/track-external-files/)の使用をお勧めします。
...
W&B を設定するための環境変数の完全なガイドについては、[環境変数リファレンス](/ja/guides/track/environment-variables/)を参照してください。
