...
- [指数移動平均](/ja/smoothing#exponential-moving-average-default) (デフォルト)
- [ガウス平滑化](/ja/smoothing#gaussian-smoothing)
- [移動平均](/ja/smoothing#running-average)
- [指数移動平均 - Tensorboard](/ja/smoothing#exponential-moving-average-deprecated) (非推奨)
