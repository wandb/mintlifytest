...
[リファレンスアーキテクチャ](/ja/../ref-arch#infrastructure-requirements)を参照してください。また、[有効な W&B サーバーライセンスを取得](/ja/../#obtain-your-wb-server-license)します。
...
移行プロセスの詳細な説明については、こちら [here](/ja/../install-on-public-cloud/aws-tf#migrate-to-operator-based-aws-terraform-modules)を参照してください。
