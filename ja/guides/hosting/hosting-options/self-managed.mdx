...
[AWS](/ja/guides/hosting/self-managed/aws-tf/)、[GCP](/ja/guides/hosting/self-managed/gcp-tf/) または [Azure](/ja/guides/hosting/self-managed/azure-tf/) に W&B Server を設定する方法については、各クラウドプロバイダーのドキュメントを参照してください。
...
オンプレインフラストラクチャーに W&B Server をインストールする方法については、[Install on on-prem infrastructure](/ja/guides/hosting/self-managed/bare-metal/) を参照してください。W&B はさまざまなコンポーネントに関する推奨事項を提供し、インストールプロセスをガイドします。
