...
環境変数を使用して、[Dedicated cloud](../advanced_env_vars) の [IAM オプションを設定](/ja/guides/hosting/hosting-options/dedicated_cloud)するか、[Self-managed](/ja/guides/hosting/hosting-options/self-managed) インスタンスを設定することができます。
