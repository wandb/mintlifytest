...
In your Python script or notebook, initialize a W&B run object with [`wandb.init()`](/ref/python/experiments/run/). Use a dictionary for the `config` parameter to specify hyperparameter names and values.
...
5. Analyze runs, visualize model predictions, and share insights on a [central dashboard](/guides/tables/).
