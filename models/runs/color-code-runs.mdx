...
The metric options in your **Key** dropdown are derived from the key-value pairs [you log to W&B](/guides/runs/color-code-runs/#custom-metrics) and [default metrics](/guides/runs/color-code-runs/#default-metrics) defined by W&B.
