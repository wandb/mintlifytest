...
This page shows how to create a Slack [automation](/guides/automations/). To create a webhook automation, refer to [Create a webhook automation](/guides/automations/create-automations/webhook/) instead.
...
1. [Create the automation](#create-an-automation), which defines the [event](/guides/automations/automation-events/) to watch for and the channel to notify.
...
1. Choose the [event](/guides/automations/automation-events/) to watch for.
