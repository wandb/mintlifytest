...
To use the Public API, you'll often need the run path which is `<entity>/<project>/<run_id>`. In the app UI, open a run page and click the [Overview tab ](/guides/track/public-api-guide/#overview-tab)to get the run path.
