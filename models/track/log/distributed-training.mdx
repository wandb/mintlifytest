...
* [Tracking each process separately](/guides/track/log/distributed-training/#track-each-process-separately) by creating a run for each process.
* [Tracking all processes to a single run](/guides/track/log/distributed-training/#track-all-processes-to-a-single-run).
...
Once you have set the `job_type` for your nodes, you can create [saved views](/guides/track/workspaces/#create-a-new-saved-workspace-view) in your workspace to organize your runs. Click the **...** action menu at the top right and click **Save as new view**.
...
See [Console logs](/guides/app/console-logs/) for more information.
...
See [Line plots](/guides/app/features/panels/line-plot/) for information on how to customize line plot panels. 
