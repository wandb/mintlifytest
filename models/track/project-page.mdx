...
* [Overview](/guides/track/project-page/#overview-tab): snapshot of your project
* [Workspace](/guides/track/project-page/#workspace-tab): personal visualization sandbox
...
* [Sweeps](/guides/sweeps/): automated exploration and optimization
* [Reports](/guides/track/project-page/#reports-tab): saved snapshots of notes, runs, and graphs
...
## Automations tab
Automate downstream actions for versioning artifacts. To create an automation, define trigger events and resulting actions. Actions include executing a webhook or launching a W&B job. For more information, see [Automations](/guides/automations/).
...
View all [artifacts](/guides/artifacts/) associated with a project, from training datasets and [fine-tuned models](/guides/registry/) to [tables of metrics and media](/guides/tables/tables-walkthrough/).
...
[Tables](/guides/tables/tables-walkthrough/) associated with artifacts are particularly rich and interactive in this context. Learn more about using Tables with Artifacts [here](/guides/tables/visualize-tables/).
