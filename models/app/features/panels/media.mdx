...
A media panel visualizes [logged keys for media objects](/guides/track/log/media/), including 3D objects, audio, images, video, or point clouds. This page shows how to add and manage media panels in a workspace.
