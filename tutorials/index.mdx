...
<CardGroup>
 <Card title="Track experiments" icon="flask" href="/tutorials/experiments"iconType="solid" horizontal/> <Card title="Visualize predictions" icon="chart-simple" href="/tutorials/tables"iconType="solid" horizontal/> <Card title="Tune hyperparameters" icon="sliders" href="/tutorials/sweeps"iconType="solid" horizontal/> <Card title="Track models and datasets" icon="database" href="/tutorials/artifacts"iconType="solid" horizontal/>
</CardGroup>
