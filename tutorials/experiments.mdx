...
1. Initialize a [run](/guides/models/track/runs/) and pass in the hyperparameters you want to track.
...
W&B runs automatically log [metrics](/guides/models/track/runs/#workspace-tab),
system information,
[hyperparameters](/guides/models/track/runs/#overview-tab),
[terminal output](/guides/models/track/runs/#logs-tab) and
you'll see an [interactive table](/guides/models/tables/)
...
W&B also makes it easy to share your saved models and model checkpoints with other members of your team or organization. To learn how to share your model and model checkpoints with members outside of your team, see [W&B Registry](/guides/core/registry/).
...
Create a [W&B Alerts](/guides/models/track/runs/alert/) to send alerts to your Slack or email from your Python code. 
...
For more details, see the [W&B Alerts overview](/guides/models/track/runs/alert).
