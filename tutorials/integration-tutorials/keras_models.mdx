...
This Colab notebook introduces the `WandbModelCheckpoint` callback. Use this callback to log your model checkpoints to W&B [Artifacts](/guides/core/artifacts/).
